...
test('anonimiza nombres personales en la copia pública y conserva las URL', () => {
  ...
  const row = sanitizePublicRecord({ description: 'Casa de Don Juan Pérez', towns: ['Valencia'], lots: 'Sin lotes', documentAnalysis: { points: [{ text: 'A nombre de Doña Ana López.' }], url: 'https://subastas.boe.es/' } });
